...
<html lang="en">
  <head>
    ...
    <link href='https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.3.0/css/all.min.css' rel= 'styleheet' crossorigin="anonymous">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="{{url('dashboard/list-users')}}">All Users</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{url('dashboard/create')}}">Create User</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
